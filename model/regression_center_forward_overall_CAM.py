...
POSITION = ''
EXPERIEMENT_NAME = "Attacking_Midfielder_overall"
...
# PLAYER_ATTRIBUTES = ['Interceptions','LongShots','Acceleration','Finishing', 'BallControl','ShotPower', 'Reactions','SprintSpeed',  'HeadingAccuracy','Positioning','Volleys','Dribbling','ShortPassing','Strength','Crossing','Composure']
...
if POSITION!='':
    df = df[df.best_position==POSITION]
