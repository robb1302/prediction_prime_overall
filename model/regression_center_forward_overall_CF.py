...
POSITION = 'CF'
EXPERIEMENT_NAME = "forward_CF_overall"
...
PLAYER_ATTRIBUTES = ['Interceptions','LongShots','Vision','Acceleration','BallControl','Dribbling',  'Reactions','Finishing','ShotPower','ShortPassing','SprintSpeed',  'HeadingAccuracy','Positioning','Volleys','Crossing']
